...
Great. Thanks, everybody, for joining. We'll see you at the next Agents of Change webinar.`,
  ...
  'from-conversation-to-knowledge': {
    ...
    targetAudience: {
      primary: 'Destination Marketing Organization (DMO) professionals',
      secondary: 'Tourism, travel, and hospitality teams, Sales and partnership managers who take a lot of meetings, Anyone drowning in notes from calls and conferences',
      tertiary: 'Knowledge workers building a personal AI workflow'
    },
    learningOutcomes: [
    ...
    relatedResources: [
      { name: 'Claude (by Anthropic)', description: 'Cowork and Code modes read and write files on your computer', url: 'https://claude.ai' },
      { name: 'Plaud', description: 'Wearable AI recording device for in-person meetings', url: 'https://www.plaud.ai' },
      { name: 'Granola', description: 'AI meeting notetaker that lives on your computer', url: 'https://www.granola.ai' },
      { name: 'Google Gemini', description: 'AI with Gems and Google Drive integration', url: 'https://gemini.google.com' },
      { name: 'ChatGPT (by OpenAI)', description: 'Projects and custom GPTs for organizing notes', url: 'https://chatgpt.com' },
      { name: 'Andrej Karpathy on GitHub', description: 'The second-brain architecture that inspired this workflow', url: 'https://github.com/karpathy' },
      { name: 'Visual Studio Code', description: 'Editor used as the interface for Claude Code', url: 'https://code.visualstudio.com' },
    ],
    chapters: [
      { time: 0, title: 'Welcome & Title' },
      { time: 8, title: 'The Problem: Notes Everywhere, Nothing Findable' },
      { time: 130, title: 'The Shift: Working Inside AI, Not as a Chatbot' },
      { time: 230, title: 'Every Call Becomes a File: The Compounding Loop' },
      { time: 330, title: 'Step 1: The 10-Minute, One-Time Setup' },
      { time: 480, title: 'Which Tool? Claude Code/Cowork vs. Gemini vs. ChatGPT' },
      { time: 760, title: 'Building the /call Skill (Paste All Three Prompts)' },
      { time: 900, title: 'YAML Front Matter, Explained' },
      { time: 1080, title: 'People, Companies, and Task Files' },
      { time: 1260, title: 'Wiki Links & Proactive Reports' },
      { time: 1360, title: 'Credit: Andrej Karpathy\'s Second-Brain Architecture' },
      { time: 1420, title: 'Step 2: Capturing — the Plaud Wearable' },
      { time: 1650, title: 'Granola & the Transparency Rule' },
      { time: 1860, title: 'Recording Laws, Consent & Sunshine Laws' },
      { time: 2040, title: 'Step 3: Run It — the /call Command Demo' },
      { time: 2220, title: 'A Sample Call Note (Marcus Donnelly / Hartwell Pierce)' },
      { time: 2400, title: 'Step 4: Retrieval in Plain English — Prep for Any Call' },
      { time: 2600, title: 'Drafting Follow-Ups in Your Voice (Janette Voice)' },
      { time: 2760, title: 'The Today Skill: Task Reminders That Resurface' },
      { time: 2850, title: 'Conferences: Turn Sessions Into Branded Recaps' },
      { time: 3050, title: 'The CLAUDE.md Rules File' },
      { time: 3150, title: 'Coaching: You Leak the Most Value After the Call' },
      { time: 3230, title: 'Get Started This Week + Next Up: Ditch the Deck (Aug 3)' }
    ],
    transcript: `Thanks everybody so much for joining. My name is Janette Roush. I'm the SVP of Innovation and the Chief AI Officer for Brand USA, and this is the Agents of Change Webinar Series. And today's webinar is a bit of a continuation actually from our previous webinar where we talked about creating your own personal operating system.
...
export const webinarMentions: Record<string, SoftwareApplicationMention[]> = {
  ...
  'from-conversation-to-knowledge': [
    { '@type': 'SoftwareApplication', name: 'Claude', applicationCategory: 'AI Assistant', url: 'https://claude.ai' },
    { '@type': 'SoftwareApplication', name: 'Claude Code', applicationCategory: 'AI Development Tool', url: 'https://claude.ai' },
    { '@type': 'SoftwareApplication', name: 'Plaud', applicationCategory: 'AI Recording Device', url: 'https://www.plaud.ai' },
    { '@type': 'SoftwareApplication', name: 'Granola', applicationCategory: 'AI Meeting Notetaker', url: 'https://www.granola.ai' },
    { '@type': 'SoftwareApplication', name: 'Google Gemini', applicationCategory: 'AI Assistant', url: 'https://gemini.google.com' },
    { '@type': 'SoftwareApplication', name: 'ChatGPT', applicationCategory: 'AI Assistant', url: 'https://chatgpt.com' },
    { '@type': 'SoftwareApplication', name: 'Microsoft Copilot', applicationCategory: 'AI Assistant', url: 'https://copilot.microsoft.com' },
    { '@type': 'SoftwareApplication', name: 'Visual Studio Code', applicationCategory: 'Code Editor', url: 'https://code.visualstudio.com' },
