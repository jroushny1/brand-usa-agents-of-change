// Field Notes content — shared by /notes, its FAQ schema, and the RSS feed.
...
// FAQ entries rendered as FAQPage schema on /notes. Add one when adding a note.
export const fieldNoteFaqs = [
  {
    "@type": "Question",
