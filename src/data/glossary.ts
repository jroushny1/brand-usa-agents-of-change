// Glossary content — terms, common FAQs, and long-tail Q&As from webinar sessions.
// Rendered on /glossary (via GlossaryClient) and in its JSON-LD schemas.
export const terms = [
  {
    name: "Operator Agent",
...
export const unexpectedQuestions = [
  {
