    ...
    <div className="space-y-6">
      ...
      {(() => {
        ...
        const checks = [
          ...
          { icon: Question, name: 'Question-format headings', count: cp.questionHeadings, per1000: cp.questionHeadingPercent, score: score(cp.questionHeadingPercent, 30, 10), unit: '% of all headings', why: 'Headings phrased as questions (How / Why / What / Should / etc., or ending in "?"). AI answers are shaped like questions, so a heading that already asks the question is easy to match and lift.' },
        ];
