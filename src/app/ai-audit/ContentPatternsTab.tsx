      ...
      <div className="bg-blue-50 p-6 rounded-lg border border-blue-100 flex items-start">
        ...
        <div>
          ...
          <p className="text-sm text-blue-800 leading-relaxed">
            This measures what your page links out to &mdash; not whether your page appears anywhere. <strong>Direct quotes</strong>, <strong>real statistics</strong>, and <strong>links to credible sources</strong> are the patterns the 2024 Princeton GEO study associated with getting cited. Newer peer-reviewed work is more skeptical: a NeurIPS 2025 benchmark tested the same tactics across six domains and found significant gains in 3 of 54 cases, and a KDD 2026 study found that rewriting body text can actually lower your odds of being retrieved at all. Treat the counts below as a craft check, not a ranking lever.
          </p>
        </div>
      </div>
        ...
        return (
          <>
            ...
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 text-xs text-gray-600 leading-relaxed">
              <strong>About these labels:</strong> Strong / Medium / Weak are rough guesses based on common ranges, not thresholds any study established. Aim for &ldquo;enough of each&rdquo; &mdash; your interview quotes, your real stats, your real source links. Made-up content to game the audit backfires; AI engines get sharper at spotting it every quarter. And know the ceiling: research in <em>Current Issues in Tourism</em> found AI travel recommendations concentrate on already-prominent destinations regardless of how individual pages are written. Content tactics won&apos;t overcome that alone &mdash; which is why the entity, schema, and crawler tabs matter more.
            </div>
          </>
        );
      })()}
